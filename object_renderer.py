...
class ObjectRenderer:
    def __init__(self, game):
        ...
        self.sky_image = self.get_texture('textures/sky.png', RES)
        self.sky_offset = 0
    ...
    def draw_background(self):
        self.sky_offset = (self.sky_offset + 4.5 * self.game.player.rel) % screen_width
        self.screen.blit(self.sky_image, (-self.sky_offset, 0))
        self.screen.blit(self.sky_image, (-self.sky_offset + screen_width, 0))
        # floor
        pg.draw.rect(self.screen, FLOOR_COLOR, (0, HALF_HEIGHT, screen_width, screen_height))
